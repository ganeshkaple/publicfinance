...
app.post("/api/newregister", function (b, c) {
	var a = b.body.fullname, e = b.body.mobile,
		d = b.body.idproof, f = b.body.idproofno,
		g = b.body.address;
	console.log(a);
...
app.post("/api/loanusers/", function (b, c) {
	var a = b.body.loan_id,
		e = b.body.loan_amount,
		d = b.body.startdate, f = b.body.enddate,
		g = b.body.installementtype,
		h = b.body.noofinstallement,
		k = b.body.dayDifference,
...
app.post("/api/insertmydate", function (b, c) {
	var a = b.body.loan_id,
		e = b.body.installement_amount,
		d = b.body.mydate, f = sizeof(d);
	console.log("POST Request :: /insert: ");
	for (var g = 0; g < f; g += 1) {
...
app.post("/api/expend", function (b, c) {
	var a = b.body.Payment, e = b.body.expenses,
		d = b.body.date,
		f = {error: 1, expenditure: ""};
	console.log("POST Request :: /insert: ");
...
app.post("/mobile/newloanusers/", function (b, c) {
	var a = b.body.loan_id,
		...
		k = b.body.dayDifference,
		l = b.body.interest,
		m = b.body.trepayamount, n = b.body.cid,
		p = b.body.userid;
	console.log("POST Request :: /insert: ");
...
app.post("/mobile/newmultiuser/", function (b, c) {
	var a = b.body.userid, e = b.body.name,
		d = b.body.mobile, f = b.body.password;
	console.log("POST Request :: /insert: ");
...
app.post("/mobile/insertmydate", function (b, c) {
	var a = b.body.userid, e = b.body.loan_id,
		d = b.body.installement_amount,
		f = b.body.mydate,
		g = sizeof(f);
	console.log("POST Request :: /insert: ");
	for (var h = 0; h < g; h += 1) {
...
app.post("/mobile/expend", function (b, c) {
	var a = b.body.Room_Rent,
		e = b.body.Light_Bill,
		d = b.body.Mobile_Bill,
		f = b.body.Payment,
		g = b.body.Petrol, h = b.body.Others,
		k = b.body.date;
	console.log(a);
